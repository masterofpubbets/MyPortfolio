        ...
        <Fragment>
            ...
            <div className="row main-div">
                ...
                <Card
                    ...
                    cardText="As I act as a data analyst I am collection, cleaning, organizing and processing data to generate information help me and my team to make decision, I am using this technique everyday job because I cannot take any step without making a good plan for it."
                    footer1="Since 2007"
                    footer2="Daily Used"
                    footer1BackColor="orange"
                    footer1ForeColor=""
            ...
            <div class="divider"></div>
            <div class="section">
                <h5 className="deep-orange-text text-darken-3"></h5>
            </div>
