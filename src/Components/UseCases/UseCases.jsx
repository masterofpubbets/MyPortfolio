...
function UseCases() {
    return (
        <div className='UseCasesSection' id='id-use-case'>
            <PageTitle title="Use Cases" color="AppColorWhite" boxColor="AppBackgroundWhite"/>
            <div className='IconsContainer row'>
                <div className='Icon col s12 m6 l3'><Icon title="UX Design" icon={UXUIIcon} color="AppColorWhite" /></div>
            </div>
            <div className='row'>
